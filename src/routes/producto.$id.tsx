      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="relative flex aspect-square items-center justify-center overflow-hidden border-2 border-foreground bg-[var(--color-surface-strong)] shadow-[10px_10px_0_var(--color-brand)]">
              <span className="absolute inset-0 opacity-55 [background-image:linear-gradient(var(--color-border)_1px,transparent_1px),linear-gradient(90deg,var(--color-border)_1px,transparent_1px)] [background-size:22px_22px]" />
              <span className="relative font-display text-[10rem] font-black uppercase text-[var(--color-ink)]/12">
